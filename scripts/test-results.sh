...
python experiments/clsf_vault.py Twitter201X --dir $twitter1x_dir/twitter2015 --vilt_model /home/mayrain/model/vilt-b32-mlm --train_split train dev --test_split test --preprocess_on_fetch --device cuda:0 --num_train_epochs 15 --reps 5
